...
interface People extends Human{ //接口不能继承非接口
	public function usePhone(); //Fatal error: People cannot implement Human - it is not an interface in /mnt/hgfs/workspace/phpper/0826/index.php on line 87
}
